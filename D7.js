...
*/
let lettereStringhe = function(string1,string2){

  let primiDueChar = string1.substring(0,2);
  let ultimiTreChar = string2.substring(string2.length - 3);
  let risultato = primiDueChar + ultimiTreChar;
  return risultato.toUpperCase()
}
console.log(lettereStringhe("ciao", "rita"));
